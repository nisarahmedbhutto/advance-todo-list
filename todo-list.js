...
while (condition) {
        ...
        let todoQuestion = await inquirer.prompt([
            {
                name: "firstQuestion",
                type: "input",
                message: chalk.blueBright.bold("what would you like to add in your todo list"),
            },
        ]);
    ...
    if (userInput.input === "update") {
        ...
        if (indexUpdate !== -1) {
            ...
            console.log(chalk.blue.bold("you update :"), chalk.red.bold(update.updateItem), chalk.green.bold(updateValue.newValue));
            console.log(chalk.green.bold(todoList));
        }
    }
    // ---------------------------------- remove -------------------------------.
        ...
        if (indexRemove >= 0) {
            ...
            console.log(chalk.blue.bold("you removed :"), chalk.red.bold(removeOption.removeItem));
            console.log(chalk.green.bold(todoList));
        }
    }
    // ------------------------------- confirmition --------------------
